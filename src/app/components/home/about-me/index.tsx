                    ...
                    <div className="container">
                        ...
                        <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
                            ...
                            <div className="w-full lg:max-w-2xl flex-1">
                                <p>
                                    Dedicated Front-End Team Lead with 4.9 years of experience specializing in React.js and
                                    the modern JavaScript ecosystem. Proven track record in architecting high-performance web
                                    and mobile applications from inception to implementation, including the pioneering of the first
                                    software division at Varun Group. Expert in translating complex business requirements into
                                    secure, role-based modules that drive executive-level tracking and operational efficiency.
                                    Commifled to fostering team collaboration, maintaining high-quality code standards, and delivering
                                    user-centric solutions that align with organizational mission and vision.
                                </p>
